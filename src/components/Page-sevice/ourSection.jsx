      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-slate-400 max-w-3xl mx-auto">
            Nous combinons design, technologie et stratégie pour donner vie à
            vos idées et créer des produits numériques exceptionnels.
          </p>
        </motion.div>
          ...
          {servicesJson2.map((service) => (
            ...
            <Link to={`/service/${service.id}`} key={service.id}>
              <motion.div
                ...
                className={`p-8 h-full rounded-2xl cursor-pointer transition-all duration-300 ${
                  colorVariants[service.color].bg
                } border ${colorVariants[service.color].border} ${
                  colorVariants[service.color].hoverBorder
                }`}
                whileHover={{ y: -8, scale: 1.03 }}
              >
                <div
                  className={`inline-block p-4 rounded-xl mb-6 bg-gradient-to-br ${
